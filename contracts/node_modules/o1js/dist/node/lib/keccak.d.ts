import { FlexibleBytes } from 'o1js/dist/node/lib/provable-types/bytes';
export { Keccak };
declare const Keccak: {
     ...
     *
     */
    nistSha3(len: 256 | 384 | 512, message: FlexibleBytes): import("o1js/dist/node/lib/provable-types/bytes").Bytes;
    /**
     ...
     * ```
     */
    ethereum(message: FlexibleBytes): import("o1js/dist/node/lib/provable-types/bytes").Bytes;
    /**
     ...
     *
     */
    preNist(len: 256 | 384 | 512, message: FlexibleBytes): import("o1js/dist/node/lib/provable-types/bytes").Bytes;
};

import { Gate, Pickles, ProvablePure } from 'o1js/dist/node/snarky';
import { Field } from 'o1js/dist/node/lib/core';
import { AccountUpdate, Permissions, SetOrKeep, ZkappPublicInput, AccountUpdateForest, AccountUpdateTree } from 'o1js/dist/node/lib/account-update';
import { FlexibleProvablePure, InferProvable } from 'o1js/dist/node/lib/circuit-value';
import { Provable } from 'o1js/dist/node/lib/provable';
import { UInt32, UInt64 } from 'o1js/dist/node/lib/int';
import { MethodInterface, Proof } from 'o1js/dist/node/lib/proof-system';
import { PrivateKey, PublicKey } from 'o1js/dist/node/lib/signature';
import { Cache } from 'o1js/dist/node/lib/proof-system/cache';
import { SmartContractBase } from 'o1js/dist/node/lib/mina/smart-contract-base';
...
declare class SmartContract extends SmartContractBase {
    ...
    static Proof(): {
        new ({ proof, publicInput, publicOutput, maxProofsVerified, }: {
            ...
            toJSON(): import("o1js/dist/node/lib/proof-system").JsonProof;
        };
        ...
        publicOutputType: import("o1js/dist/node/lib/circuit-value").ProvablePureExtended<undefined, null>;
        ...
        }>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, publicOutput: publicOutputJson, }: import("o1js/dist/node/lib/proof-system").JsonProof): Proof<InferProvable<S["publicInputType"]>, InferProvable<S["publicOutputType"]>>;
    ...
    static compile({ cache, forceRecompile, }?: {
        ...
        verify: (statement: Pickles.Statement<import("o1js/dist/node/lib/field").FieldConst>, proof: unknown) => Promise<boolean>;
    }>;
    /**
     ...
     */
    get account(): import("o1js/dist/node/lib/precondition").Account;
    /**
     * Current network state of the {@link SmartContract}.
     */
    get network(): import("o1js/dist/node/lib/precondition").Network;
    /**
     ...
     */
    get currentSlot(): import("o1js/dist/node/lib/precondition").CurrentSlot;
    /**
     * @deprecated
     ...
     */
    get balance(): {
        addInPlace(x: string | number | bigint | UInt64 | UInt32 | import("o1js/dist/node/lib/int").Int64): void;
        subInPlace(x: string | number | bigint | UInt64 | UInt32 | import("o1js/dist/node/lib/int").Int64): void;
    };
    /**
...
declare function Account(address: PublicKey, tokenId?: Field): import("o1js/dist/node/lib/precondition").Account;
/**

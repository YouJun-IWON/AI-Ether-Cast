...
import { Field3, Sum } from 'o1js/dist/node/lib/gadgets/foreign-field';
import { divMod32, addMod32 } from 'o1js/dist/node/lib/gadgets/arithmetic';
export { Gadgets };
declare const Gadgets: {
     ...
     * ```
     */
    isInRangeN(n: number, x: Field): import("o1js/dist/node/lib/bool").Bool;
     ...
     * ```
     */
    rotate64(field: Field, bits: number, direction?: 'left' | 'right'): import("o1js/dist/node/lib/field").Field;
    /**
     * A (left and right) rotation operates similarly to the shift operation (`<<` for left and `>>` for right) in JavaScript,
     ...
     * ```
     */
    rotate32(field: Field, bits: number, direction?: 'left' | 'right'): import("o1js/dist/node/lib/field").Field;
    /**
     ...
     * ```
     */
    xor(a: Field, b: Field, length: number): import("o1js/dist/node/lib/field").Field;
    /**
     ...
     */
    not(a: Field, length: number, checked?: boolean): import("o1js/dist/node/lib/field").Field;
    /**
     ...
     * ```
     */
    leftShift64(field: Field, bits: number): import("o1js/dist/node/lib/field").Field;
    /**
     * Performs a left shift operation on the provided {@link Field} element.
     * This operation is similar to the `<<` shift operation in JavaScript,
     * where bits are shifted to the left, and the overflowing bits are discarded.
     ...
     * ```
     */
    leftShift32(field: Field, bits: number): import("o1js/dist/node/lib/field").Field;
    /**
     ...
     * ```
     */
    rightShift64(field: Field, bits: number): import("o1js/dist/node/lib/field").Field;
    /**
     ...
     * ```
     */
    and(a: Field, b: Field, length: number): import("o1js/dist/node/lib/field").Field;
    /**
     * Multi-range check.
     *
     ...
     */
    compactMultiRangeCheck(xy: Field, z: Field): [import("o1js/dist/node/lib/field").Field, import("o1js/dist/node/lib/field").Field, import("o1js/dist/node/lib/field").Field];
    /**
    ...
    Field3: {
        ...
        toBigints<T extends import("o1js/dist/node/lib/util/types").Tuple<Field3>>(...xs: T): [...{ [i in keyof T]: bigint; }];
        isConstant(x: Field3): boolean;
        provable: import("o1js/dist/node/bindings/lib/generic").GenericProvableExtendedPure<[import("o1js/dist/node/lib/field").Field, import("o1js/dist/node/lib/field").Field, import("o1js/dist/node/lib/field").Field], [string, string, string], import("o1js/dist/node/lib/field").Field>;
    };
    /**
     ...
     */
    SHA256: {
        hash(data: import("o1js/dist/node/lib/provable-types/bytes").FlexibleBytes): import("o1js/dist/node/lib/provable-types/bytes").Bytes;
    };
};

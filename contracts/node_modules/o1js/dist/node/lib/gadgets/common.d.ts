import { Field, VarField } from 'o1js/dist/node/lib/field';
import { Tuple, TupleN } from 'o1js/dist/node/lib/util/types';
...
declare function exists<N extends number, C extends () => TupleN<bigint, N>>(n: N, compute: C): TupleN<VarField, N>;
/**
 ...
 */
declare function toVar(x: Field | bigint): VarField;

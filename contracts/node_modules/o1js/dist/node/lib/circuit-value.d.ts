...
import { ProvablePure } from 'o1js/dist/node/snarky';
import { Field } from 'o1js/dist/node/lib/core';
import { provable, provablePure, provableTuple, HashInput, NonMethods } from 'o1js/dist/node/bindings/lib/provable-snarky';
import type { InferJson, InferProvable, InferredProvable, IsPure } from 'o1js/dist/node/bindings/lib/provable-snarky';
...
declare abstract class CircuitValue {
    ...
    toJSON(): any;
    toConstant(): this;
    equals(x: this): import("o1js/dist/node/lib/bool").Bool;

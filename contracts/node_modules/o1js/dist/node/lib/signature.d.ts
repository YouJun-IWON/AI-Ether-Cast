import { Field, Bool, Group, Scalar } from 'o1js/dist/node/lib/core';
import { CircuitValue, AnyConstructor } from 'o1js/dist/node/lib/circuit-value';
import { PrivateKey as PrivateKeyBigint } from 'o1js/dist/node/provable/curve-bigint';
...
declare function scaleShifted(point: Group, shiftedScalar: Scalar): import("o1js/dist/node/lib/group").Group;

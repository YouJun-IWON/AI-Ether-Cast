...
import { Provable as Provable_ } from 'o1js/dist/node/snarky';
import type { FlexibleProvable } from 'o1js/dist/node/lib/circuit-value';
import { Context } from 'o1js/dist/node/lib/global-context';
import { InferredProvable } from 'o1js/dist/node/bindings/lib/provable-snarky';
import { inCheckedComputation, inProver, asProver, runAndCheck, runUnchecked, constraintSystem } from 'o1js/dist/node/lib/provable-context';
export { Provable };
...
declare function getBlindingValue(): import("o1js/dist/node/lib/field").Field;

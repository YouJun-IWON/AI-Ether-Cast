import { CurveParams } from 'o1js/dist/node/bindings/crypto/elliptic-curve';
import { ProvablePureExtended } from 'o1js/dist/node/lib/circuit-value';
import { FlexiblePoint, ForeignCurve } from 'o1js/dist/node/lib/foreign-curve';
...
import { Bytes } from 'o1js/dist/node/lib/provable-types/provable-types';
...
declare class EcdsaSignature {
     ...
     * ```
     */
    verify(message: Bytes, publicKey: FlexiblePoint): import("o1js/dist/node/lib/bool").Bool;
    /**
     ...
     */
    verifySignedHash(msgHash: AlmostForeignField | bigint, publicKey: FlexiblePoint): import("o1js/dist/node/lib/bool").Bool;
    /**

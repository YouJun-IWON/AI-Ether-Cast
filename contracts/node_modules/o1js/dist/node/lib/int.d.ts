...
import { AnyConstructor, CircuitValue } from 'o1js/dist/node/lib/circuit-value';
import { Types } from 'o1js/dist/node/bindings/mina-transaction/types';
import { HashInput } from 'o1js/dist/node/lib/hash';
import { FieldVar } from 'o1js/dist/node/lib/field';
...
declare class UInt64 extends CircuitValue {
     ...
     */
    lte(y: UInt64): import("o1js/dist/node/lib/bool").Bool;
    /**
     * Checks if a {@link UInt64} is less than or equal to another one.
     */
    lessThanOrEqual(y: UInt64): import("o1js/dist/node/lib/bool").Bool;
    /**
     ...
     */
    lt(y: UInt64): import("o1js/dist/node/lib/bool").Bool;
    /**
     *
     * Checks if a {@link UInt64} is less than another one.
     */
    lessThan(y: UInt64): import("o1js/dist/node/lib/bool").Bool;
    /**
     *
     ...
     */
    gt(y: UInt64): import("o1js/dist/node/lib/bool").Bool;
    /**
     * Checks if a {@link UInt64} is greater than another one.
     */
    greaterThan(y: UInt64): import("o1js/dist/node/lib/bool").Bool;
    /**
     ...
     */
    gte(y: UInt64): import("o1js/dist/node/lib/bool").Bool;
    /**
     * Checks if a {@link UInt64} is greater than or equal to another one.
     */
    greaterThanOrEqual(y: UInt64): import("o1js/dist/node/lib/bool").Bool;
    /**
...
declare class UInt32 extends CircuitValue {
     ...
     */
    lte(y: UInt32): import("o1js/dist/node/lib/bool").Bool;
    /**
     * Checks if a {@link UInt32} is less than or equal to another one.
     */
    lessThanOrEqual(y: UInt32): import("o1js/dist/node/lib/bool").Bool;
    /**
     * @deprecated Use {@link assertLessThanOrEqual} instead.
     *
     ...
     */
    lt(y: UInt32): import("o1js/dist/node/lib/bool").Bool;
    /**
     * Checks if a {@link UInt32} is less than another one.
     */
    lessThan(y: UInt32): import("o1js/dist/node/lib/bool").Bool;
    /**
     * @deprecated Use {@link assertLessThan} instead.
     *
     ...
     */
    gt(y: UInt32): import("o1js/dist/node/lib/bool").Bool;
    /**
     * Checks if a {@link UInt32} is greater than another one.
     */
    greaterThan(y: UInt32): import("o1js/dist/node/lib/bool").Bool;
    /**
     * @deprecated Use {@link assertGreaterThan} instead.
     *
     ...
     */
    gte(y: UInt32): import("o1js/dist/node/lib/bool").Bool;
    /**
     * Checks if a {@link UInt32} is greater than or equal to another one.
     */
    greaterThanOrEqual(y: UInt32): import("o1js/dist/node/lib/bool").Bool;
    /**
     * @deprecated Use {@link assertGreaterThanOrEqual} instead.
...
declare class Sign extends CircuitValue {
    ...
    neg(): Sign;
    mul(y: Sign): Sign;
    isPositive(): import("o1js/dist/node/lib/bool").Bool;
    toString(): string;
}
...
declare class Int64 extends CircuitValue implements BalanceChange {
     ...
     */
    equals(y: Int64 | number | string | bigint | UInt64 | UInt32): import("o1js/dist/node/lib/bool").Bool;
    /**
...
declare class UInt8 extends UInt8_base {
     ...
     * ```
     */
    greaterThan(y: UInt8 | bigint | number): import("o1js/dist/node/lib/bool").Bool;
    /**
     ...
     * ```
     */
    greaterThanOrEqual(y: UInt8 | bigint | number): import("o1js/dist/node/lib/bool").Bool;
    /**

import { FlexibleProvable } from 'o1js/dist/node/lib/circuit-value';
import { Provable } from 'o1js/dist/node/lib/provable';
import { Field, Bool } from 'o1js/dist/node/lib/core';
...
import { UInt64, UInt32, Int64, Sign } from 'o1js/dist/node/lib/int';
import type { SmartContract } from 'o1js/dist/node/lib/zkapp';
import { Preconditions, Account, Network, CurrentSlot, OrIgnore, ClosedInterval } from 'o1js/dist/node/lib/precondition';
import { Empty, Proof } from 'o1js/dist/node/lib/proof-system';
import { Events, Actions } from 'o1js/dist/node/bindings/mina-transaction/transaction-leaves';
import { CallForest } from 'o1js/dist/node/mina-signer/src/sign-zkapp-command';
import { MerkleList, MerkleListBase } from 'o1js/dist/node/lib/provable-types/merkle-list';
import { Hashed } from 'o1js/dist/node/lib/provable-types/packed';
export { AccountUpdate, Permissions, ZkappPublicInput, TransactionVersion, AccountUpdateForest, AccountUpdateTree, };
export { SetOrKeep, Permission, Preconditions, Body, Authorization, FeePayerUnsigned, ZkappCommand, addMissingSignatures, addMissingProofs, Events, Actions, TokenId, Token, CallForest, zkAppProver, dummySignature, LazyProof, AccountUpdateTreeBase, AccountUpdateLayout, hashAccountUpdate, HashedAccountUpdate, };
...
declare const TokenId: {
    default: import("o1js/dist/node/lib/field").Field;
    derive(tokenOwner: PublicKey, parentTokenId?: import("o1js/dist/node/lib/field").Field): Field;
    toBase58(t: import("o1js/dist/node/lib/field").Field): string;
    fromBase58(base58: string): import("o1js/dist/node/lib/field").Field;
    empty: () => import("o1js/dist/node/lib/field").Field;
    sizeInFields: () => number;
    toFields: (x: import("o1js/dist/node/lib/field").Field) => import("o1js/dist/node/lib/field").Field[];
    toAuxiliary: (x?: import("o1js/dist/node/lib/field").Field | undefined) => any[];
    fromFields: (x: import("o1js/dist/node/lib/field").Field[], aux: any[]) => import("o1js/dist/node/lib/field").Field;
    check: (x: import("o1js/dist/node/lib/field").Field) => void;
    toInput: (x: import("o1js/dist/node/lib/field").Field) => {
        fields?: import("o1js/dist/node/lib/field").Field[] | undefined;
        packed?: [import("o1js/dist/node/lib/field").Field, number][] | undefined;
    };
    toJSON(x: import("o1js/dist/node/lib/field").Field): string;
    fromJSON(x: string): import("o1js/dist/node/lib/field").Field;
};
/**
...
declare class Token {
    static Id: {
        default: import("o1js/dist/node/lib/field").Field;
        derive(tokenOwner: Types.PublicKey, parentTokenId?: import("o1js/dist/node/lib/field").Field): import("o1js/dist/node/lib/field").Field;
        toBase58(t: import("o1js/dist/node/lib/field").Field): string;
        fromBase58(base58: string): import("o1js/dist/node/lib/field").Field;
        empty: () => import("o1js/dist/node/lib/field").Field;
        sizeInFields: () => number;
    ...
    static getId(tokenOwner: PublicKey, parentTokenId?: import("o1js/dist/node/lib/field").Field): import("o1js/dist/node/lib/field").Field;
    readonly id: Field;
...
declare class AccountUpdate implements Types.AccountUpdate {
    ...
    static Actions: {
        toFields: (x: {
            data: import("o1js/dist/node/lib/field").Field[][];
        ...
        fromFields: (x: import("o1js/dist/node/lib/field").Field[], aux: any[]) => {
            data: import("o1js/dist/node/lib/field").Field[][];
            hash: import("o1js/dist/node/lib/field").Field;
        };
        sizeInFields(): number;
        ...
        pushEvent(actions: {
            hash: import("o1js/dist/node/lib/field").Field;
            data: import("o1js/dist/node/lib/field").Field[][];
        }, event: import("o1js/dist/node/lib/field").Field[]): {
            hash: import("o1js/dist/node/lib/field").Field;
            data: import("o1js/dist/node/lib/field").Field[][];
        };
        fromList(events: import("o1js/dist/node/lib/field").Field[][]): {
            hash: import("o1js/dist/node/lib/field").Field;
            data: import("o1js/dist/node/lib/field").Field[][];
        };
        hash(events: import("o1js/dist/node/lib/field").Field[][]): import("o1js/dist/node/lib/field").Field;
        emptyActionState(): import("o1js/dist/node/lib/field").Field;
        updateSequenceState(state: import("o1js/dist/node/lib/field").Field, sequenceEventsHash: import("o1js/dist/node/lib/field").Field): import("o1js/dist/node/lib/field").Field;
    };
    ...
    get tokenId(): import("o1js/dist/node/lib/field").Field;
    /**
    ...
    isDummy(): import("o1js/dist/node/lib/bool").Bool;
    ...
    static toFields: (value: Types.AccountUpdate) => import("o1js/dist/node/lib/field").Field[];
    ...
    static get MayUseToken(): {
        type: import("o1js/dist/node/snarky").ProvablePure<{
            parentsOwnToken: import("o1js/dist/node/lib/bool").Bool;
            inheritFromParent: import("o1js/dist/node/lib/bool").Bool;
        }> & {
            toInput: (x: {
                parentsOwnToken: import("o1js/dist/node/lib/bool").Bool;
                inheritFromParent: import("o1js/dist/node/lib/bool").Bool;
        ...
        isNo({ body: { mayUseToken: { parentsOwnToken, inheritFromParent }, }, }: AccountUpdate): import("o1js/dist/node/lib/bool").Bool;
        isParentsOwnToken(a: AccountUpdate): import("o1js/dist/node/lib/bool").Bool;
        isInheritFromParent(a: AccountUpdate): import("o1js/dist/node/lib/bool").Bool;
    };
    /**
...
declare function hashAccountUpdate(update: AccountUpdate): import("o1js/dist/node/lib/field").Field;
declare const HashedAccountUpdate_base: {
    new (hash: import("o1js/dist/node/lib/field").Field, value: import("o1js/dist/node/lib/circuit-value").Unconstrained<AccountUpdate>): Hashed<AccountUpdate>;
    create<T>(type: import("o1js/dist/node/lib/hash").ProvableHashable<T>, hash?: ((t: T) => import("o1js/dist/node/lib/field").Field) | undefined): {
        new (hash: import("o1js/dist/node/lib/field").Field, value: import("o1js/dist/node/lib/circuit-value").Unconstrained<T>): Hashed<T>;
        create<T>(type: import("o1js/dist/node/lib/hash").ProvableHashable<T>, hash?: ((t: T) => import("o1js/dist/node/lib/field").Field) | undefined): any & {
            provable: import("o1js/dist/node/lib/hash").ProvableHashable<Hashed<T>>;
        };
        _hash(_: any): import("o1js/dist/node/lib/field").Field;
        hash<T_1>(value: T_1, hash?: import("o1js/dist/node/lib/field").Field | undefined): Hashed<T_1>;
        _provable: import("o1js/dist/node/lib/hash").ProvableHashable<Hashed<any>> | undefined;
        _innerProvable: import("o1js/dist/node/lib/hash").ProvableHashable<any> | undefined;
        readonly innerProvable: import("o1js/dist/node/lib/hash").ProvableHashable<any>;
    } & {
        provable: import("o1js/dist/node/lib/hash").ProvableHashable<Hashed<T>>;
    };
    _hash(_: any): import("o1js/dist/node/lib/field").Field;
    ...
    provable: import("o1js/dist/node/lib/hash").ProvableHashable<Hashed<AccountUpdate>>;
};
...
declare const AccountUpdateForest_base: {
    ...
    create<T>(type: import("o1js/dist/node/lib/hash").ProvableHashable<T>, nextHash?: (hash: import("o1js/dist/node/lib/field").Field, value: T) => import("o1js/dist/node/lib/field").Field, emptyHash_?: import("o1js/dist/node/lib/field").Field): {
        new ({ hash, data }: MerkleListBase<T>): MerkleList<T>;
        create<T>(type: import("o1js/dist/node/lib/hash").ProvableHashable<T>, nextHash?: (hash: import("o1js/dist/node/lib/field").Field, value: T) => import("o1js/dist/node/lib/field").Field, emptyHash_?: import("o1js/dist/node/lib/field").Field): any & {
            empty: () => MerkleList<T>;
            from: (array: T[]) => MerkleList<T>;
            provable: import("o1js/dist/node/lib/hash").ProvableHashable<MerkleList<T>>;
        };
        _nextHash: ((hash: import("o1js/dist/node/lib/field").Field, t: any) => import("o1js/dist/node/lib/field").Field) | undefined;
        _emptyHash: import("o1js/dist/node/lib/field").Field | undefined;
        _provable: import("o1js/dist/node/lib/hash").ProvableHashable<MerkleList<any>> | undefined;
        _innerProvable: import("o1js/dist/node/lib/hash").ProvableHashable<any> | undefined;
        readonly emptyHash: import("o1js/dist/node/lib/field").Field;
    } & {
        empty: () => MerkleList<T>;
        from: (array: T[]) => MerkleList<T>;
        provable: import("o1js/dist/node/lib/hash").ProvableHashable<MerkleList<T>>;
    ...
    provable: import("o1js/dist/node/lib/hash").ProvableHashable<MerkleList<{
        id: number;
        accountUpdate: Hashed<AccountUpdate>;
        children: MerkleListBase<AccountUpdateTreeBase>;
    }>>;
...
declare let ZkappPublicInput: import("o1js/dist/node/snarky").ProvablePure<{

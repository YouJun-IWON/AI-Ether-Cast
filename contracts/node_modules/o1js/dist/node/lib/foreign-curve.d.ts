import { CurveParams, CurveAffine } from 'o1js/dist/node/bindings/crypto/elliptic-curve';
import { ProvablePureExtended } from 'o1js/dist/node/lib/circuit-value';
import { AlmostForeignField } from 'o1js/dist/node/lib/foreign-field';
import { Point } from 'o1js/dist/node/lib/gadgets/elliptic-curve';
import { Field3 } from 'o1js/dist/node/lib/gadgets/foreign-field';
...
declare class ForeignCurve {
     ...
     */
    toBigint(): import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
    /**
    ...
    static get Bigint(): {
        ...
        hasCofactor: boolean;
        zero: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
        one: {
            infinity: boolean;
            x: bigint;
            y: bigint;
        ...
        readonly Endo: {
            ...
            endomorphism(P: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine): {
                x: bigint;
                y: bigint;
            };
            scaleProjective(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupProjective, s: bigint): {
                x: bigint;
                y: bigint;
                z: bigint;
            };
            scale(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine, s: bigint): import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
        };
        from(g: {
            x: bigint;
            y: bigint;
        }): import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
        fromNonzero(g: {
            x: bigint;
            y: bigint;
        }): import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
        equal(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine, h: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine): boolean;
        isOnCurve(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine): boolean;
        isInSubgroup(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine): boolean;
        add(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine, h: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine): import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
        double(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine): import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
        negate(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine): import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
        sub(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine, h: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine): import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
        scale(g: import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine, s: bigint | boolean[]): import("o1js/dist/node/bindings/crypto/elliptic-curve").GroupAffine;
    };
    /**

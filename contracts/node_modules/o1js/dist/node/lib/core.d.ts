import { Field as InternalField } from 'o1js/dist/node/lib/field';
import { Bool as InternalBool } from 'o1js/dist/node/lib/bool';
import { Group as InternalGroup } from 'o1js/dist/node/lib/group';
import { Scalar } from 'o1js/dist/node/lib/scalar';
 ...
 */
declare const Field: typeof InternalField & ((x: string | number | bigint | import("o1js/dist/node/lib/field").FieldVar | import("o1js/dist/node/lib/field").FieldConst | InternalField) => InternalField);
 ...
 * ```
 */
declare const Bool: typeof InternalBool & ((x: boolean | InternalBool | import("o1js/dist/node/lib/field").FieldVar) => InternalBool);
type Bool = InternalBool;
/**
 * An element of a Group.
 */
declare const Group: typeof InternalGroup & ((args_0: {
    x: string | number | bigint | import("o1js/dist/node/lib/field").FieldVar | InternalField;
    y: string | number | bigint | import("o1js/dist/node/lib/field").FieldVar | InternalField;
}) => InternalGroup);

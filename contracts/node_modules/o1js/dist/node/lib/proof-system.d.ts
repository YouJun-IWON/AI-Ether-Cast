import { ProvablePure, Pickles, Gate, GateType } from 'o1js/dist/node/snarky';
import { Field, Bool } from 'o1js/dist/node/lib/core';
import { FlexibleProvable, FlexibleProvablePure, InferProvable, ProvablePureExtended } from 'o1js/dist/node/lib/circuit-value';
...
declare namespace ZkProgram {
    var Proof: <PublicInputType extends FlexibleProvablePure<any>, PublicOutputType extends FlexibleProvablePure<any>>(program: {
        ...
        new ({ proof, publicInput, publicOutput, maxProofsVerified, }: {
            ...
            publicInput: import("o1js/dist/node/bindings/lib/provable-generic").InferProvable<PublicInputType, import("o1js/dist/node/lib/field").Field>;
            publicOutput: import("o1js/dist/node/bindings/lib/provable-generic").InferProvable<PublicOutputType, import("o1js/dist/node/lib/field").Field>;
            proof: unknown;
            maxProofsVerified: 0 | 2 | 1;
            shouldVerify: import("o1js/dist/node/lib/bool").Bool;
            verify(): void;
        ...
        fromJSON<S extends Subclass<typeof import("o1js/dist/node/lib/proof-system").Proof>>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, publicOutput: publicOutputJson, }: JsonProof): Proof<InferProvable<S["publicInputType"]>, InferProvable<S["publicOutputType"]>>;
        /**
         * Dummy proof. This can be useful for ZkPrograms that handle the base case in the same
         * method as the inductive case, using a pattern like this:
         *

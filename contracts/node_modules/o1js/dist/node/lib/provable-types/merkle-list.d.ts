import { Bool, Field } from 'o1js/dist/node/lib/core';
import { Unconstrained } from 'o1js/dist/node/lib/circuit-value';
import { ProvableHashable } from 'o1js/dist/node/lib/hash';
...
declare const emptyHash: import("o1js/dist/node/lib/field").Field;
type WithHash<T> = {
    previousHash: Field;
    element: T;
};
...
declare class MerkleList<T> implements MerkleListBase<T> {
    ...
    isEmpty(): import("o1js/dist/node/lib/bool").Bool;
    /**
     ...
     * ```
     */
    static create<T>(type: ProvableHashable<T>, nextHash?: (hash: Field, value: T) => Field, emptyHash_?: import("o1js/dist/node/lib/field").Field): typeof MerkleList<T> & {
        empty: () => MerkleList<T>;
    ...
    static get emptyHash(): import("o1js/dist/node/lib/field").Field;
...
declare class MerkleListIterator<T> implements MerkleListIteratorBase<T> {
    ...
    assertAtStart(): void;
    isAtEnd(): import("o1js/dist/node/lib/bool").Bool;
    jumpToEnd(): void;
     ...
     */
    static create<T>(type: ProvableHashable<T>, nextHash?: (hash: Field, value: T) => Field, emptyHash_?: import("o1js/dist/node/lib/field").Field): typeof MerkleListIterator<T> & {
    ...
    static createFromList<T>(merkleList: typeof MerkleList<T>): {
         ...
         * Create a Merkle array type
         */
        create<T_1>(type: ProvableHashable<T_1>, nextHash?: (hash: import("o1js/dist/node/lib/field").Field, value: T_1) => import("o1js/dist/node/lib/field").Field, emptyHash_?: import("o1js/dist/node/lib/field").Field): {
            new (value: MerkleListIteratorBase<T_1>): MerkleListIterator<T_1>;
            create<T_1>(type: ProvableHashable<T_1>, nextHash?: (hash: import("o1js/dist/node/lib/field").Field, value: T_1) => import("o1js/dist/node/lib/field").Field, emptyHash_?: import("o1js/dist/node/lib/field").Field): any & {
            ...
            _nextHash: ((hash: import("o1js/dist/node/lib/field").Field, value: any) => import("o1js/dist/node/lib/field").Field) | undefined;
...
declare function genericHash<T>(provable: ProvableHashable<T>, prefix: string, value: T): import("o1js/dist/node/lib/field").Field;
declare function merkleListHash<T>(provable: ProvableHashable<T>, prefix?: string): (hash: Field, value: T) => import("o1js/dist/node/lib/field").Field;

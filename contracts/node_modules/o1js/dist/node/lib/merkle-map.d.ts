import { CircuitValue } from 'o1js/dist/node/lib/circuit-value';
import { Field, Bool } from 'o1js/dist/node/lib/core';
import { MerkleTree } from 'o1js/dist/node/lib/merkle-tree';
export declare class MerkleMap {
     ...
     */
    get(key: Field): import("o1js/dist/node/lib/field").Field;
    /**
     * Returns the root of the Merkle Map.
     * @returns The root of the Merkle Map.
     */
    getRoot(): import("o1js/dist/node/lib/field").Field;
    /**
...
export declare class MerkleMapWitness extends CircuitValue {
     ...
     */
    computeRootAndKey(value: Field): import("o1js/dist/node/lib/field").Field[];
}

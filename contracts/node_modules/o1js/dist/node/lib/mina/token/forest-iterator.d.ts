import { AccountUpdate, AccountUpdateForest, AccountUpdateTreeBase } from 'o1js/dist/node/lib/account-update';
import { Field } from 'o1js/dist/node/lib/core';
import { Provable } from 'o1js/dist/node/lib/provable';
import { MerkleListIterator, MerkleList } from 'o1js/dist/node/lib/provable-types/merkle-list';
export { TokenAccountUpdateIterator };
declare const Layer_base: (new (value: {
    forest: MerkleListIterator<{
        id: number;
        accountUpdate: import("o1js/dist/node/lib/provable-types/packed").Hashed<AccountUpdate>;
        children: import("o1js/dist/node/lib/provable-types/merkle-list").MerkleListBase<AccountUpdateTreeBase>;
    }>;
    mayUseToken: {
...
declare class TokenAccountUpdateIterator {
    ...
    next(): {
        ...
        usesThisToken: import("o1js/dist/node/lib/bool").Bool;
    };

import { ZkappCommand, ZkappPublicInput } from 'o1js/dist/node/lib/account-update';
...
import { type DeprecatedFeePayerSpec, type FeePayerSpec } from 'o1js/dist/node/lib/mina/mina-instance';
import { type SendZkAppResponse } from 'o1js/dist/node/lib/mina/graphql';
import { type FetchMode } from 'o1js/dist/node/lib/mina/transaction-context';
export { type Transaction, type PendingTransaction, type IncludedTransaction, type RejectedTransaction, type PendingTransactionStatus, createTransaction, sendTransaction, newTransaction, getAccount, transaction, createRejectedTransaction, createIncludedTransaction, };
/**
 ...
 */
type PendingTransaction = Pick<Transaction, 'transaction' | 'toJSON' | 'toPretty'> & {
    /**
...
declare function newTransaction(transaction: ZkappCommand, proofsEnabled?: boolean): Transaction;
/**
...
declare function sendTransaction(txn: Transaction): Promise<PendingTransaction>;
/**

import { PublicKey, UInt64, UInt32, TokenId, Field, Bool, AuthRequired, Sign } from 'o1js/dist/node/bindings/mina-transaction/transaction-leaves';
import { GenericProvableExtended } from 'o1js/dist/node/bindings/lib/generic';
import { GenericLayout } from 'o1js/dist/node/bindings/lib/from-layout';
import * as Json from 'o1js/dist/node/bindings/mina-transaction/gen/transaction-json';
export { customTypes, ZkappCommand, AccountUpdate, Account };
export { Json };
export * from 'o1js/dist/node/bindings/mina-transaction/transaction-leaves';
...
declare let provableFromLayout: <T, TJson>(typeData: GenericLayout<TypeMap>) => {
    sizeInFields(): number;
    toFields(value: T): import("o1js/dist/node/lib/field").Field[];
    toAuxiliary(value?: T | undefined): any[];
    fromFields(fields: import("o1js/dist/node/lib/field").Field[], aux: any[]): T;
...
declare let ZkappCommand: {
    sizeInFields(): number;
    toFields(value: ZkappCommand): import("o1js/dist/node/lib/field").Field[];
    toAuxiliary(value?: ZkappCommand | undefined): any[];
    fromFields(fields: import("o1js/dist/node/lib/field").Field[], aux: any[]): ZkappCommand;
...
declare let AccountUpdate: {
    sizeInFields(): number;
    toFields(value: AccountUpdate): import("o1js/dist/node/lib/field").Field[];
    toAuxiliary(value?: AccountUpdate | undefined): any[];
    fromFields(fields: import("o1js/dist/node/lib/field").Field[], aux: any[]): AccountUpdate;
...
declare let Account: {
    sizeInFields(): number;
    toFields(value: Account): import("o1js/dist/node/lib/field").Field[];
    toAuxiliary(value?: Account | undefined): any[];
    fromFields(fields: import("o1js/dist/node/lib/field").Field[], aux: any[]): Account;

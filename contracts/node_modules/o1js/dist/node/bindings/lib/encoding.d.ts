 ...
 */
declare function stringToFields(message: string): import("o1js/dist/node/lib/field").Field[];
/**
 ...
 */
declare function bytesToFields(bytes: Uint8Array): import("o1js/dist/node/lib/field").Field[];
/**
...
declare const Bijective: {
    Fp: {
        ...
        fromBytes: (bytes: Uint8Array) => import("o1js/dist/node/lib/field").Field[];
        toString(fields: Field[]): string;
        fromString(message: string): import("o1js/dist/node/lib/field").Field[];
    };
    Fq: {
        toBytes: (fields: Field[]) => Uint8Array;
        fromBytes: (bytes: Uint8Array) => import("o1js/dist/node/lib/field").Field[];

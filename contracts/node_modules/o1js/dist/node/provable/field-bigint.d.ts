import { HashInput } from 'o1js/dist/node/bindings/lib/provable-bigint';
...
declare const Bool: ((value: boolean) => Bool) & {
    ...
    readBytes<N extends number>(bytes: number[], offset: import("o1js/dist/node/bindings/crypto/non-negative").NonNegativeInteger<N>): [value: Bool, offset: number];
...
declare const Sign: ((value: 1 | -1) => Sign) & {
    ...
    readBytes<N extends number>(bytes: number[], offset: import("o1js/dist/node/bindings/crypto/non-negative").NonNegativeInteger<N>): [value: Sign, offset: number];

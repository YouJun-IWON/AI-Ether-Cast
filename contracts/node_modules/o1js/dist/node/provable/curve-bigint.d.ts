import { GroupProjective } from 'o1js/dist/node/bindings/crypto/elliptic-curve';
import { Bool, Field } from 'o1js/dist/node/provable/field-bigint';
import { HashInputLegacy } from 'o1js/dist/node/provable/poseidon-bigint';
...
declare const PublicKey: {
    ...
    readBytes<N extends number>(bytes: number[], offset: import("o1js/dist/node/bindings/crypto/non-negative").NonNegativeInteger<N>): [value: {
        x: bigint;
        isOdd: Bool;
    }, offset: number];
